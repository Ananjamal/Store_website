    ...
    <div class="py-4 container-fluid">
        <div class="row">
            <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
                <div class="card">
                    <div class="p-3 pt-2  card-header">
                        <div
                            class="text-center icon icon-lg icon-shape bg-gradient-dark shadow-dark border-radius-xl mt-n4 position-absolute">
                            <i class="material-icons opacity-10">weekend</i>
                        </div>
                        <div class="pt-1 text-end">
                            <p class="mb-0 text-sm text-capitalize">Today's Money</p>
                            <h4 class="mb-0">$53k</h4>
                        </div>
                    </div>
                    <hr class="my-0 dark horizontal">
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-success font-weight-bolder">+55% </span>than last
                            week</p>
                    </div>
                </div>
            </div>
            <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
                <div class="card">
                    <div class="p-3 pt-2 card-header">
                        <div
                            class="text-center icon icon-lg icon-shape bg-gradient-primary shadow-primary border-radius-xl mt-n4 position-absolute">
                    ...
                    <hr class="my-0 dark horizontal">
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-success font-weight-bolder">+3% </span>than last
                            month</p>
                    </div>
                </div>
            </div>
            <div class="mb-4 col-xl-3 col-sm-6 mb-xl-0">
                <div class="card">
                    <div class="p-3 pt-2 card-header">
                        <div
                            class="text-center icon icon-lg icon-shape bg-gradient-success shadow-success border-radius-xl mt-n4 position-absolute">
                            <i class="material-icons opacity-10">person</i>
                        </div>
                        <div class="pt-1 text-end">
                    ...
                    <hr class="my-0 dark horizontal">
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-danger font-weight-bolder">-2%</span> than
                            yesterday</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="p-3 pt-2 card-header">
                        <div
                            class="text-center icon icon-lg icon-shape bg-gradient-info shadow-info border-radius-xl mt-n4 position-absolute">
                            <i class="material-icons opacity-10">weekend</i>
                        </div>
                        <div class="pt-1 text-end">
                    ...
                    <hr class="my-0 dark horizontal">
                    <div class="p-3 card-footer">
                        <p class="mb-0"><span class="text-sm text-success font-weight-bolder">+5% </span>than
                            yesterday</p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-4 row">
            ...
            <div class="mt-4 mb-4 col-lg-4 col-md-6">
                <div class="card z-index-2 ">
                    <div class="p-0 mx-3 bg-transparent card-header position-relative mt-n4 z-index-2">
                        <div class="py-3 bg-gradient-success shadow-success border-radius-lg pe-1">
                            <div class="chart">
                        ...
                        <div class="row">
                            ...
                            <div class="my-auto col-lg-6 col-5 text-end">
                                <div class="dropdown float-lg-end pe-4">
                                    ...
                                    <ul class="px-2 py-3 dropdown-menu ms-sm-n4 ms-n5"
                    ...
                    <div class="p-3 card-body">
                        <div class="timeline timeline-one-side">
                            ...
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">Server payments for April
                                    </h6>
                            ...
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">New card added for order
                                        #4395133</h6>
                            ...
                            <div class="mb-3 timeline-block">
                                ...
                                <div class="timeline-content">
                                    <h6 class="mb-0 text-sm text-dark font-weight-bold">Unlock packages for
                                        development</h6>
